...
const CopyButton = ({ text = "Hello World", children, className = "", ...props }: any) => {
...
const FlipButton = ({ children, className = "", ...props }: any) => (
  <button
...
// GitHub Stars Button Implementation  
const GitHubStarsButton = ({ repo = "owner/repo", stars = 1234, className = "", ...props }: any) => (
  <button
...
const IconButton = ({ icon: Icon = Send, className = "", ...props }: any) => {
...
const InputButton = ({ placeholder = "Enter text...", className = "", ...props }: any) => {
      ...
      {isExpanded ? (
        <div className="flex">
          ...
          <button
            ...
            className="rounded-r-lg bg-primary px-3 py-2 text-primary-foreground hover:bg-primary/90"
          >
        ...
        <button
          ...
          className={`rounded-full bg-primary p-2 text-primary-foreground transition-all duration-300 hover:bg-primary/90 ${className}`}
          {...props}
        >
          <Send className="h-4 w-4" />
        </button>
...
const LiquidButton = ({ children, className = "", ...props }: any) => (
  <button
    className={`group relative overflow-hidden rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-3 text-white font-medium transition-all duration-500 hover:from-blue-600 hover:to-blue-700 ${className}`}
    {...props}
  >
