    ...
    <div className="space-y-8">
      <div className="max-w-2xl">
        <p className="text-muted-foreground text-sm leading-relaxed">
          Discover a comprehensive collection of button components and interactions. 
          From subtle hover effects to complex animations, each implementation 
          demonstrates modern interaction patterns and accessibility best practices. 
