  ...
  return (
    <div className="container mx-auto max-w-7xl space-y-8 p-4">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold tracking-tight">Effects Components Overview</h1>
        <p className="text-muted-foreground">
          The Effects section features interactive and animated visual effects to enhance user engagement. Discover components like glowing cards, animated borders, and meteor backgrounds to add dynamic flair to your UI.
        </p>
      </div>
