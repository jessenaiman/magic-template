  ...
  return (
    <div className="container mx-auto max-w-7xl space-y-8 p-4">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold tracking-tight">Background Components Overview</h1>
        <p className="text-muted-foreground">
          The Backgrounds section showcases animated and static background patterns for modern interfaces. Explore reusable components like animated grids, dot patterns, and retro effects to enhance your UI’s visual depth and interactivity.
        </p>
      </div>
