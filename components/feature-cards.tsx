...
/**
 * NOTE:
 * This is a direct TypeScript conversion of the previous FeatureCards.jsx.
 * Kept structure minimal per instructions (no added demo/testimonials logic).
 * Any future design adjustments can be iterated here without disturbing page.tsx.
 */
