...
export function DesignManagementBar({ pathname, updateCustomization, setPlaying, playing, reset }: DesignManagementBarProps) {
  ...
  const playbackButtons = React.useMemo(() => [
    {
      ...
      className: 'bg-neutral-200/60 dark:bg-neutral-600/80 text-neutral-600 dark:text-neutral-200'
    },
    {
      icon: RotateCcw,
      label: 'Reset',
  ...
  const themeButtons = React.useMemo(() => [
    ...
    },
    {
      ...
      className: 'bg-neutral-800/80 dark:bg-neutral-800/80 text-neutral-200 dark:text-neutral-200'
    },
    {
      icon: Paintbrush,
      label: 'Colorful',
      ...
      className: 'bg-blue-200/60 dark:bg-blue-800/80 text-blue-600 dark:text-blue-300'
    }
  ], [updateCustomization]);
