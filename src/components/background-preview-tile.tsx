...
export function BackgroundPreviewTile(props: BackgroundPreviewTileProps) {
  ...
  return (
    <PreviewTile {...props} initialCustomization={mergedInitialCustomization} />
  );
}
...
export function withBackgroundCustomization<P extends object>(
  WrappedComponent: React.ComponentType<
    P & { customization?: Partial<CustomizationSettings> }
  >
) {
  return function WithBackgroundCustomization(props: P) {
    ...
    return (
      <WrappedComponent {...props} customization={backgroundCustomization} />
    );
  };
}
