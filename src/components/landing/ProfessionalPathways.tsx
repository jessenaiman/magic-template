...
export const ProfessionalPathways: React.FC<ProfessionalPathwaysProps> = ({
  className,
}) => {
      ...
      <div className="container mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <p className="mt-6 text-base md:text-lg text-muted-foreground">
            From rapid prototyping sprints to embedded design-engineering
            collaboration—pick the level of involvement that accelerates your
            roadmap without slowing experimentation.
          </p>
        </motion.div>
        ...
        <div className="mt-10 text-center">
          <p className="text-xs text-muted-foreground">
            Open-source foundations + focused collaboration. Sustainable
            velocity without reinventing the wheel.
          </p>
        </div>
      </div>
