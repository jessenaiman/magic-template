      ...
      <div className="container mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <p className="mt-6 text-base md:text-lg text-muted-foreground">
            Start playful. Scale into focused output. Embed sustained momentum
            when you need a design-engineering multiplier. Reference{' '}
            <a
              href="/design"
        ...
        >
          Pricing values shown as placeholders while packaging final access
          tiers. Custom / hybrid models available for teams with unique pipeline
          constraints.
        </motion.p>
      </div>
