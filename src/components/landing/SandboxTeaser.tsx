...
export const SandboxTeaser: React.FC<SandboxTeaserProps> = ({
  className,
  id = 'sandbox',
}) => {
        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
          ...
          >
            <div
              ...
              style={{
                maskImage:
                  'radial-gradient(circle at 35% 30%, black 0%, transparent 65%)',
              }}
            />
          ...
          >
            ...
            <p className="mt-6 text-base md:text-lg text-muted-foreground">
              The sandbox is where layout feel, timing curves, responsive shifts
              & spacing scales become tangible. Try a variant, commit or
              discard—zero cost. Save only what works.
            </p>
            ...
            <p className="mt-6 text-xs text-muted-foreground">
              Prefer minimalist? Motion trims itself for reduced-motion users
              automagically.
            </p>
          </motion.div>
        </div>
