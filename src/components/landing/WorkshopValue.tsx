        ...
        >
          ...
          >
            <span className="bg-gradient-to-b from-foreground via-foreground/90 to-foreground/60 bg-clip-text text-transparent">
              <ShinyText text="Visual" speed={7} className="px-0.5" />{' '}
              Adjustments
            </span>
            <span className="inline-block mx-2 text-primary/60 align-middle">
              →
            </span>
          ...
          <p className="mt-6 text-base md:text-lg text-muted-foreground">
            Skip static mockups. Touch real components, test motion & spacing,
            then ship the code you just shaped. Creative velocity without
            structural debt.
          </p>
