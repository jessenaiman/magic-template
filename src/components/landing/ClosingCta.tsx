      ...
      <div className="container mx-auto max-w-5xl px-6 text-center">
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base md:text-lg text-muted-foreground">
            Open a surface, poke the pixels, feel the motion, export clean code.
            Exploration-first workflow that preserves velocity while keeping
            handoff faithful.
          </p>
        </motion.div>
        ...
        >
          Prefer async review? Send context & goals—receive variants + annotated
          diffs.
        </motion.p>
      </div>
