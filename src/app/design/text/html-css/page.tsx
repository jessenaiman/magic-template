...
export default function HtmlCssTextPage() {
    ...
    <div className="space-y-6">
      <div className="space-y-2">
        <h2 className="text-2xl font-bold tracking-tight">
          HTML/CSS Text Components
        </h2>
        <p className="text-muted-foreground">
          Pure HTML and CSS text styling and animations. These examples
          demonstrate fundamental web technologies without JavaScript
          dependencies.
        </p>
      </div>
  ...
  CSS Gradient Magic
      ...
      >
        {customization => (
          <div className="css-gradient-text">CSS Gradient Magic</div>
        )}
      </PreviewTile>
  ...
  Shiny Effect
      ...
      >
        {customization => <div className="css-shiny-text">Shiny Effect</div>}
      </PreviewTile>
  ...
  Shadow Magic
      ...
      >
        {customization => <div className="css-text-shadow">Shadow Magic</div>}
      </PreviewTile>
