    ...
    <div className="container mx-auto max-w-7xl space-y-8 p-4">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold tracking-tight">
          Magic UI Text Components
        </h1>
        <p className="text-muted-foreground">
          Explore animated and interactive text components powered by Magic UI.
          These components add motion, engagement, and visual appeal to your
          typography.
        </p>
      </div>
      <PreviewTile
    ...
    Experience the magic as this text reveals itself with smooth animation. Scroll to see the effect in action!
      ...
      >
        <div className="h-32 overflow-y-auto rounded-md border border-dashed p-4 bg-muted/20">
          <TextReveal>
            Experience the magic as this text reveals itself with smooth
            animation. Scroll to see the effect in action!
          </TextReveal>
        </div>
      </PreviewTile>
    </div>
