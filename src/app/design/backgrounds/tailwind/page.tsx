    ...
    <div className="space-y-8">
      <div className="max-w-2xl">
        <p className="text-muted-foreground text-sm leading-relaxed">
          Explore Tailwind CSS-powered background patterns and effects. These
          examples demonstrate how to create beautiful, responsive backgrounds
      ...
      >
        <div className="h-64 w-full rounded-lg relative overflow-hidden">
          <div
            ...
            style={{
              backgroundImage:
                'linear-gradient(45deg, #f1f5f9 25%, transparent 25%, transparent 50%, #f1f5f9 50%, #f1f5f9 75%, transparent 75%, transparent)',
              backgroundSize: '20px 20px',
            }}
          ></div>
        </div>
